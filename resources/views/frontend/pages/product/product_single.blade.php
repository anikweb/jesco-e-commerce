                    ...
                    <div class="product-details-content quickview-content">
                        ...
                        <div class="color">
                            @foreach ($product->attribute->unique('color_id') as $attribute)
                                <label for="color_id">
                                    <input class="color_id" id="color_id" data-product="{{ $product->id }}" value="{{ $attribute->color_id }}" style="width: auto; height:auto" type="radio"> {{ Str::title($attribute->color->name) }}
                                </label>
                            @endforeach
                        </div>
                        <div class="sizeName">
